...
import { getAllEmails, searchEmails, type Email } from "@/lib/search/emails";

const toListItem = (email: Email) => ({
  id: email.id,
  from: email.from,
...
export default async function SearchPage(props: {
  ...
  const perPage = Math.max(1, Math.floor(Number(searchParams.perPage)) || 10);
